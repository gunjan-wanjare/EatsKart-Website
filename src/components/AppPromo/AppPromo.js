import './AppPromo.css';
import { APP_STORE_HREF, GET_IN_TOUCH_HREF, GOOGLE_PLAY_HREF } from '../../constants/routes';
      ...
      <div className="container app-promo__layout">
        <div className="app-promo__content">
          ...
          <div className="app-promo__stores">
            <a href={APP_STORE_HREF} className="app-promo__store-btn">
            ...
            <a href={GOOGLE_PLAY_HREF} className="app-promo__store-btn">
          ...
          <a href={GET_IN_TOUCH_HREF} className="app-promo__learn">
            Learn More
            <svg
